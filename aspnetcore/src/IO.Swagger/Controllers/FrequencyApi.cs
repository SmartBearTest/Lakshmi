...
{ 
    ...
    { 
        /// <summary>
        /// Returns a JSON list of frequencies.
        /// </summary>
        /// <remarks>Returns a list of frequencies</remarks>
        /// <response code="200">OK</response>
        /// <response code="401">Unauthorized</response>
        [HttpGet]
        [Route("/databuffet/api/v1/frequencies")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("FrequencyIndex")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<FrequencyInfo>), description: "OK")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Unauthorized")]
        public virtual IActionResult FrequencyIndex()
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(List<FrequencyInfo>));
            ...
            exampleJson = "[ {\n  \"frequencyId\" : 0,\n  \"frequencyName\" : \"frequencyName\"\n}, {\n  \"frequencyId\" : 0,\n  \"frequencyName\" : \"frequencyName\"\n} ]";
                        ...
                        ? JsonConvert.DeserializeObject<List<FrequencyInfo>>(exampleJson)
                        : default(List<FrequencyInfo>);            //TODO: Change the data returned
